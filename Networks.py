...
class Networks():
    ...
    # General convulution block, including the possibility to set batch-normalization, and different activation functions   
    def general_conv2d(self, input_data, filters = 64,  kernel_size = 7, stride = 1, stddev = 0.02, activation_function = "relu", padding = "VALID", do_norm=True, relu_factor = 0, name="conv2d"):
        with tf.variable_scope(name):
            ...
            return conv
    # General deconvulution block, including the possibility to set batch-normalization, and different activation functions   
