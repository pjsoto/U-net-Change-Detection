...
# Model
parser.add_argument('--method_type', dest='method_type', type=str, default='Unet', help='method that will be used')
# Training parameters
...
parser.add_argument('--buffer_dimension_out', dest='buffer_dimension_out', type=int, default=2, help='Dimension of the buffer outside of the area')
parser.add_argument('--buffer_dimension_in', dest='buffer_dimension_in', type=int, default=0, help='Dimension of the buffer inside of the area')
